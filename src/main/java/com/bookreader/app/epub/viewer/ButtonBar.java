...
class ButtonBar extends JPanel {
	...
	public ButtonBar(Navigator navigator, ContentPane chapterPane) {
		...
		//Set ToolTipText
		startButton.setToolTipText("Chapter first");
		previousChapterButton.setToolTipText("Chapter previous");
		previousPageButton.setToolTipText("Page previous");
		nextPageButton.setToolTipText("Page next");
		nextChapterButton.setToolTipText("Chapter next");
		endButton.setToolTipText("Chapter last");
