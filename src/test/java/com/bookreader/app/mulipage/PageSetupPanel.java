package com.bookreader.app.mulipage;
...
public class PageSetupPanel extends JPanel {
    ...
    protected void initLayout() {
        ...
        add(new JLabel("By default LETTER paper is used. Margins are 0.25\"."), new GridBagConstraints(0,0,2,1,1,0,GridBagConstraints.NORTHWEST,GridBagConstraints.HORIZONTAL, new Insets(5,5,0,5),0,0));
        ...
        add(new JLabel("Paper width:"), new GridBagConstraints(0,2,1,1,0,0,GridBagConstraints.NORTHWEST,GridBagConstraints.HORIZONTAL, new Insets(5,5,0,5),0,0));
        ...
        add(new JLabel("Paper height:"), new GridBagConstraints(0,3,1,1,0,0,GridBagConstraints.NORTHWEST,GridBagConstraints.HORIZONTAL, new Insets(5,5,10,5),0,0));
        ...
        add(new JLabel("Margin top:"), new GridBagConstraints(0,4,1,1,0,0,GridBagConstraints.NORTHWEST,GridBagConstraints.HORIZONTAL, new Insets(5,5,0,5),0,0));
        ...
        add(new JLabel("Margin left:"), new GridBagConstraints(0,5,1,1,0,0,GridBagConstraints.NORTHWEST,GridBagConstraints.HORIZONTAL, new Insets(5,5,0,5),0,0));
        ...
        add(new JLabel("Margin bottom:"), new GridBagConstraints(0,6,1,1,0,0,GridBagConstraints.NORTHWEST,GridBagConstraints.HORIZONTAL, new Insets(5,5,0,5),0,0));
        ...
        add(new JLabel("Margin right:"), new GridBagConstraints(0,7,1,1,0,0,GridBagConstraints.NORTHWEST,GridBagConstraints.HORIZONTAL, new Insets(5,5,0,5),0,0));
