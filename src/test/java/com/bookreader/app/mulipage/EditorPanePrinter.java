...
import com.bookreader.app.zoom.ScaledEditorKit;
...
public class EditorPanePrinter extends JPanel implements Pageable, Printable {
    ...
    public void doPagesLayout() {
        ...
        this.setPreferredSize(new Dimension(576,PAGE_SHIFT+count*(pageHeight+PAGE_SHIFT)));
        
        setBorder(BorderFactory.createLineBorder(Color.RED));
        sourcePane.setBorder(BorderFactory.createLineBorder(Color.BLUE));
        System.out.println("Editor"+sourcePane.getSize());
